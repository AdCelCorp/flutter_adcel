...
/** FlutterAdcelPlugin */
public class FlutterAdcelPlugin implements FlutterPlugin, MethodCallHandler, InterstitialListener {
  ...
  public FlutterAdcelPlugin(Activity mActivity, MethodChannel mChannel) {
